...
class TestCostEffectivenessEvaluator:
    ...
    def test_evaluator_with_random_baseline_with_sample_data_if_no_exception_is_thrown(
        self, fs
    ):
    ...
    def test_evaluator_with_longest_road_baseline_with_sample_data_if_no_exception_is_thrown(
        self, fs
    ):
