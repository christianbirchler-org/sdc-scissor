...
from sdc_scissor.testing_api.test_generators.frenetic.src.utils import frenet
...
class BaseFrenetGenerator(BaseGenerator):
    def __init__(self, executor=None, map_size=None, segment_length=10, lane_width=4, strict_father=False,
    ...
    def is_likely_self_intersecting(self, road_points) -> bool:
        ...
        drop_road_checks = {'left_complex': not left_line.is_simple,
